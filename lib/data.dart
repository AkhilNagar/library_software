...
List<Book> getBookList(){
  return <Book>[
    Book(
      "Zero To One",
      "An inside look at Peter Thiel’s philosophy and strategy for making your startup a success by looking at the lessons he learned from founding and selling PayPal, investing in Facebook and becoming a billionaire in the process.",
      Author(
        "Peter Thiel",
        90,
        "images/Peter_Thiel.jpg",
      ),
      "4.14",
      "images/ZeroToOne.jpeg",
    ),
    Book(
      "Rich Dad Poor Dad",
      "",
      Author(
        "Robert Kiyosaki",
        123,
        "images/RobertKiyosaki.jpeg",
      ),
      "4.14",
      "images/RichDadPoorDad.jpeg",
    ),
    Book(
      "The Dreamers",
